...
public class GameHumanActivity extends BaseActivity {
    ImageButton[][] blocks;
    Button reset, score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player2 = new Player(loadDataString(KEY_PLAYER2_NAME));
        game = new Game();
        ...
        score.setOnClickListener(view -> goTo(GameHumanActivity.this, ScoreActivity.class));
